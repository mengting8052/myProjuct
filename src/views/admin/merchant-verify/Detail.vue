<template>
  <Form :model="form.data" ref="editForm" :rules="form.rules" inline :label-width="100">
    ...
    <FormItem :label="$t('tenantManage.form.label.userName')" prop="userName">
      <Input v-model="form.data.userName" :maxlength="128" disabled></Input>
    </FormItem>
    ...
    <!-- <FormItem :label="$t('tenantManage.form.label.originalPassword')" prop="originalPassword">
          <Input v-model="form.data.originalPassword" :maxlength="64" disabled></Input>
    </FormItem>-->
    <br>
    <!-- 地址 -->
    ...
    <FormItem :label="$t('tenantManage.form.label.remark')" prop="remark">
      <Input type="textarea" v-model="form.data.remark" :maxlength="64"></Input>
    </FormItem>
    <br>
    <FormItem prop="appIds">
      ...
      <CheckboxGroup v-model="form.data.appIds" @on-change="checkBoxGroupChange">
        <Checkbox v-for="appId in appIdList" :label="appId.id" :key="appId.id">{{appId.name}}</Checkbox>
      </CheckboxGroup>
    </FormItem>
    <br>
    <FormItem>
