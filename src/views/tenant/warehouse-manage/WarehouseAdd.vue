<template>
  <div>
    <Form ref="addWareHouse" :model="modal.data" :label-width="100" :rules="modal.rules">
      <Row>
        <Col span="12">
          <!-- 上级部门 -->
          <FormItem
          ...
          <FormItem :label="$t('warehouseManage.form.label.name')" prop="warehouseDetail.name">
            <Input type="text" v-model="modal.data.warehouseDetail.name" :maxlength="64"></Input>
          </FormItem>
          <!-- 仓库编号 -->
          <FormItem :label="$t('warehouseManage.form.label.code')" prop="warehouseDetail.code">
            <Input type="text" v-model="modal.data.warehouseDetail.code" :maxlength="64"></Input>
          </FormItem>
          <!-- 仓库简称 -->
          <FormItem
...
import { add } from "@/api/tenant/wareHouse";
